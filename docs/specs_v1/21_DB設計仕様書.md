...
* レコード（JV-Data）→カラムの対応表（参照: `docs/specs/22_データ辞書.md`）
* 取得仕様（JVOpen/JVRTOpenの引数・実行例）（参照: `docs/specs/10_データ取得仕様書.md`）
* 特徴量/検証/運用（参照: `docs/specs/30_特徴量仕様書.md`, `docs/specs/40_検証設計仕様書.md`, `docs/specs/50_運用仕様書.md`）
...
* データ辞書（レコード→カラム）: `docs/specs/22_データ辞書.md`
* データ設計メモ: `docs/specs/21_DB設計仕様書.md`

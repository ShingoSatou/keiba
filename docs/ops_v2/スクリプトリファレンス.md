...
graph TD
    ...
    FEAT_BASE -->|scripts_v2/train_ranker_v2.py| OOF1[data/oof/ranker_oof.parquet]
    OPTUNA_LGBM -->|scripts_v2/train_ranker_v2.py --params-json| OOF1
